...
export FZF_CTRL_T_OPTS="--walker-skip .git,node_modules,target --preview 'bat -n --theme=\"Catppuccin Macchiato\" --color=always {}' --bind 'ctrl-/:change-preview-window(down|hidden|)'"
